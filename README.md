...
# My Customized CV Template

This is a personalized LaTeX CV template derived from the [McDowell CV](https://github.com/dnl-blkv/mcdowell-cv).

## Changes Made:
- Customized the original template for personal branding.
- Renamed `.tex` and output `.pdf` filenames for clarity.
- Minor formatting improvements and layout adjustments.

## How to Build:

Make sure LuaLaTeX is installed and run:

```bash
lualatex CV_Template.tex
```
...
## Screenshot
<img src="McDowell_CV.png" width="240px"/>
